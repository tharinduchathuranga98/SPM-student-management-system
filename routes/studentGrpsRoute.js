...
//http://localhost:8000/studentGrps
router.get ("/", async (req, res, next) => {
    ...
    return res.status(200).json({ studentGrps });
  });

  //http://localhost:8000/studentGrps/add
  router.post ("/add", async (req, res, next) => {
    ...
    return res.status(201).json({ stGrp });
  });
...
router.get("/:id",async(req,res,next) => {
    ...
    return res.status(200).json({ stdGrp });
  });
