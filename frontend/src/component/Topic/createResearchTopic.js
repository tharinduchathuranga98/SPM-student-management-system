...
export default class createResearchTopic extends Component {
  ...
  onSubmit = (e) => {
    ...
    const { studentsGrpId, researchField, supervisorName, selectedTopic, grpLeaderName, grpLeaderEmail } = this.state;
    ...
    //const re = /^[0-9\b]+$/;
    if (studentsGrpId == "" || researchField == "" || supervisorName == "" || selectedTopic == "" || grpLeaderName == "" || grpLeaderEmail == "") {
      ...
      swal(" Please Enter Supervisor Name Correctly", "length should be greater than 2", "error");
    }    
    //}
      ...
      swal({
        ...
        .then((willDelete) => {
          if (willDelete) {
            ...
            axios.post("/postTopic/save", data).then((res) => {
              if (res.data.success) {
                ...
                <div className="container-fluid">
                  <div className="Jumbotron jumbotron-fluid">
                    <div className="container hire">
                      <br />
                      <marquee direction="left"><p className="display-3 " style = {{color:'#8b4513'}}><b>Register Your Research Topic Today !</b></p></marquee>
                    </div>
                  </div>
                </div>
              </div>
              ...
              <div className="myformstyle" style={{ width: "95%", marginLeft: "0px" }}>
                ...
                <div className="card-body">
                  <div className="col-md-8 mt-4 mx-auto">
                    <h1 className="text-center topic" style = {{color:'#00008b'}}>Research Topic Registration Form </h1>
                    <br></br>
                    ...
                    <form className="needs-validation" align="center" style={{ width: "110%", borderStyle: "solid", borderWidth:"5px", boxShadow: "0 8px 350px 0 rgba(0, 0, 0, 0.5)", alignContent:"center", borderColor:"navy"}} noValidate >
                      <div className="form-group" style={{ marginBottom: '15px' }}><br></br>
                        <label style={{ marginBottom: '5px',fontSize:'19px' }} className="topic"><b>Students' Group ID: </b></label>
                        <input type="text"
                      ...
                      <br></br>
                      <div className="form-group" style={{ marginBottom: '15px' }}><br></br>
                        <label style={{ marginBottom: '5px',fontSize:'19px' }} className="topic"><b>Selected Research Topic: </b></label>
                        <input type="text"
                          className="form-control"
                          name="selectedTopic"
                      ...
                      <div className="form-group" style={{ marginBottom: '15px' }}><br></br>
                        <label style={{ marginBottom: '5px',fontSize:'19px' }} className="topic"><b>Name Of Group Leader: </b></label>
                        <input type="text"
                          className="form-control"
                          name="grpLeaderName"
                      ...
                      <div className="form-group" style={{ marginBottom: '15px' }}><br></br>
                        <label style={{ marginBottom: '5px',fontSize:'19px' }} className="topic"><b>Email Of Group Leader: </b></label>
                        <input type="text"
                          className="form-control"
                          name="grpLeaderEmail"
                      ...
                      <br />
                      <button className="btn btn-dark" type="submit" style={{ marginTop: '15px' }} ><a href="/email"> <i className="far fa-check-square" style={{ textDecoration: "none" }}></i>
                        &nbsp; Request Supervisor Via Email</a></button>
