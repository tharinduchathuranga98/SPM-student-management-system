...
onSubmit = (e) => {
  ...
  if (studentsGrpId == "" || researchField == "" || supervisorName == "" || selectedTopic == "" || grpLeaderName == "" || grpLeaderEmail == "") {
    ...
    axios.put(`/postTopic/update/${id} `, data).then((res) => {
...
componentDidMount(){
  ...
  axios.get(`/postTopic/${id}`).then((res) => {
        ...
        <div className="cardU" style={{ marginTop: '40px' }}>
          <div className="card-body">
            ...
            <div className="col-md-8 mt-4 mx-auto">
              <center>
                <h1 className="h3 mb-3 font-weight-normal" style={{ backgroundColor: '#d4eff9', marginTop: '40px', color: 'navy' }}><font face="Comic sans MS" size="6"><b>Accept/Reject Reserach Topic Details</b></font></h1><br />
              </center>
              <br />
              <form className="needs-validation" noValidate >
                <div className="form-group" style={{ marginBottom: '15px' }}>
                  <label style={{ marginBottom: '5px' }}><b>Students' Group ID: </b></label>
                  <input type="text"
