...
export default class studentGrpsDetails extends Component {
  ...
  render() {
    ...
    const {leaderName, leaderID, leaderEmail, member1Name, member1ID,
       member1Email, member2Name,  member2ID, member2Email, member3Name, member3ID, member3Email} = this.state.studentGrp;
    return (
